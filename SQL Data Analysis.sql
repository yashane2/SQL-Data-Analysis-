...
Select 
	store_id,rating,
    Count(inventory_id) as No_of_inventory_items 
from 
	inventory
...
*/ 
Select 
	store_id,category.name as film_category,
...
Union
Select 
	'Advisor' as type, first_name, last_name, null as company_name
from 
	advisor;
